...
const Draggable = class {
     ...
     * @tutorial adding_option_contain
     * @param {string} [opts.cursor = 'default'] - a valid CSS cursor
     * @param {function | null} [opts.onDrag = null] - a function to invoke while the element is being dragged
     * @param {function | null} [opts.onDrop = null] - a function to invoke while the element is dropped 
     * @param {function | null} [opts.onGrab = null] - a function to invoke when the element is first grabbed
     * @param {function | null} [opts.onHover = null] - a function to invoke while the element is being hovered over by the cursor
     * @param {boolean} [opts.showCoords = false] - if true, the `x` and `y` coordinates while be shown next to the cursor
     * 
     */
